...
import { useIsLayerHidden } from "../../stores/layerAtoms"; // Corrected path
import { filterFeaturesByIds, filterFeaturesByType } from "../helper"; // Corrected path
import useImageLoader from "../hooks/useImageLoader"; // Corrected path
...
export default function IconLayer({
  ...
  return (
    <Source id={`${imageType}-icon-source`} type="geojson" data={featureCollection}>
      <Layer
        id={layerId}
        type="symbol"
        layout={{

...
vi.mock("@/components/ui/popover", () => ({
  Popover: ({
    ...
    <div data-testid="popover" data-open={open}>
      {children}
      <button type="button" data-testid="toggle-popover" onClick={() => onOpenChange?.(!open)}>
        Toggle
      </button>
    </div>
  ),
...
describe("CityCombobox", () => {
  ...
  describe("when user interacts with dropdown", () => {
    it("should provide search functionality", () => {
      ...
      // Assert
      expect(screen.getByTestId("command-input")).toHaveAttribute("placeholder", "Search city...");
    });

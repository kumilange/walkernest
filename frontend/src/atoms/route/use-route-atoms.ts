...
import { routeAtom, isStartingPointSelectingAtom, isEndingPointSelectingAtom, startingPointAtom, endingPointAtom } from './route-atoms';
...
export function useAtomRoute() {
	...
	return { route, setRoute, startingPoint, setStartingPoint, endingPoint, setEndingPoint, isStartingPointSelecting, setIsStartingPointSelecting, isEndingPointSelecting, setIsEndingPointSelecting };
}
